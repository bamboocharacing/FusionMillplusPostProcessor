...
(function (Formats) {
    ...
    Formats.T = createFormat({ decimals: 6, forceDecimal: true, scale: 100 });
    ...
    Formats.Sec = createFormat({ decimals: 1 });
...
var Modals;
(function (Modals) {
    Modals.GMotion = createModal({ force: true }, Formats.G);
    Modals.Plane = createModal({ onchange: function () { Modals.GMotion.reset(); } }, Formats.G);
    Modals.AbsInc = createModal({}, Formats.G);
    Modals.FeedMode = createModal({}, Formats.G);
    Modals.Unit = createModal({}, Formats.G);
    Modals.Cycle = createModal({}, Formats.G);
})(Modals || (Modals = {}));
var Outputs;
(function (Outputs) {
...
//# sourceMappingURL=tsc_post_out.js.map